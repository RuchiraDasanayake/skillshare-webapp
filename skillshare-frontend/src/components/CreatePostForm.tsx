            ...
            <div className="mb-8">
              ...
              <div className="relative">
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={8}
                  placeholder="Tell us what you'll be sharing in a compelling way..."
                  className="w-full min-h-[220px] px-6 py-5 text-base text-gray-800 bg-white border border-purple-300 rounded-2xl shadow-sm focus:ring-2 focus:ring-purple-500 focus:outline-none transition-all duration-300 resize-none"
                />
                <button
                  type="button"
